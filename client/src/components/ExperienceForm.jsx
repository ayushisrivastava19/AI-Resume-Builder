    ...
    const generateDescription = async(index)=>{
        ...
        try {
           ...
           updateExperience(index, "description", data.enhancedContent)
            ...
            toast.error("AI didn't generate anything")
            }
        } catch (error) {
                ...
                <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3">
                    <div className='flex justify-between items-start'>
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea value={experience.description || ""} onChange={(e)=> updateExperience(index, "description", e.target.value)} rows={4} className="w-full text-sm px-3 py-2 rounded-lg resize-none" placeholder="Describe you key responsibilities and achievements..."/>
                        </div>
                </div>
                ))}
            </div>
